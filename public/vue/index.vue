    ...
    <v-expansion-panels v-model="panel">
      <v-expansion-panel>
        ...
        <v-expansion-panel-content>
          <v-list v-if="$store.state.tabsUpToDate">
            <v-list-item v-for="tab in $store.state.tabs" :key="tab.id" :to="'tab/' + tab.id">
          ...
          <v-container class="text-center pt-0" v-if="!$store.state.tabsUpToDate">
...
module.exports = {
  ...
  computed: {
    tabs: function() { return this.$store.state.tabs }
  }
}
</script>
